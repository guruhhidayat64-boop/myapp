<x-app-layout>
    <x-slot name="header">
        Kelola Kelas (Rombongan Belajar)
    </x-slot>
            ...
            <table class="min-w-full">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse ($classes as $class)
                        <tr>
                            <td class="px-6 py-4 font-medium whitespace-nowrap">{{ $class->name }}</td>
                            <td class="px-6 py-4 whitespace-nowrap">{{ $class->gradeLevel->name ?? 'N/A' }}</td>
