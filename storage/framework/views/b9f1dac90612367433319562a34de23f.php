...
<body class="font-sans antialiased">
    <div id="sidebar-wrapper" class="min-h-screen bg-gray-100 flex" x-data="{ open: true }">
        ...
        <aside :class="{ 'w-64': open, 'w-20': !open }"
            ...
            <nav class="mt-5">
                <a href="<?php echo e(route('dashboard')); ?>"
                    class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 <?php echo e(request()->routeIs('dashboard') ? 'bg-gray-700' : ''); ?>">
            ...
            <header class="bg-white shadow flex justify-between items-center p-4">
                ...
                <div class="relative" x-data="{ dropdownOpen: false }">
                    <button @click="dropdownOpen = !dropdownOpen"
                        ...
                        <h2 class="text-sm font-medium text-gray-700"><?php echo e(Auth::user()->name); ?></h2>
...
<?php /**PATH D:\laragon\www\myapp\resources\views/layouts/app.blade.php ENDPATH**/ ?>