...
<?php $component->withAttributes([]); ?>
    ...
    <div class="space-y-6">
        ...
        <div id="result-wrapper" class="hidden p-6 bg-white rounded-lg shadow-md">
            ...
            <form id="save-form" action="<?php echo e(route('teacher.learning-objectives.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            generateBtn.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch("<?php echo e(route('teacher.learning-objectives.generateAi')); ?>", {
                        method: 'POST',
                        headers: {
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\myapp\resources\views/guru/learning_objectives/create.blade.php ENDPATH**/ ?>