...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="p-6 bg-white rounded-lg shadow-md flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold text-gray-800"><?php echo e($tpCount); ?></p>
            </div>
        </div>
        ...
        <div class="p-6 bg-white rounded-lg shadow-md flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold text-gray-800"><?php echo e($atpCount); ?></p>
            </div>
        </div>
        ...
        <div class="p-6 bg-white rounded-lg shadow-md flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold text-gray-800"><?php echo e($rpCount); ?></p>
            </div>
        </div>
    </div>

    <!-- ==================== PANEL BARU: PERLU TINJAUAN ==================== -->
    <?php if($flowsForRevision->isNotEmpty()): ?>
    <div class="mt-8 p-6 bg-red-50 border-l-4 border-red-500 rounded-r-lg shadow-md">
        ...
        <div class="space-y-3">
            <?php $__currentLoopData = $flowsForRevision; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $flow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('teacher.teaching-flows.edit', $flow)); ?>" class="block p-3 bg-white rounded-md hover:shadow-lg transition-shadow">
                <div class="flex justify-between items-center">
                    <div>
                        <p class="font-semibold text-gray-800"><?php echo e($flow->name); ?></p>
                        <p class="text-sm text-gray-500"><?php echo e($flow->subject->name); ?> / <?php echo e($flow->gradeLevel->name); ?></p>
                    </div>
                    <span class="text-sm font-medium text-red-600">Lihat Umpan Balik &rarr;</span>
                </div>
                <?php if($flow->feedback): ?>
                <div class="mt-2 p-2 text-sm bg-red-100 border-t border-red-200 text-red-900 rounded-b-md">
                    <strong>Catatan dari Kepala Sekolah:</strong> <?php echo e(\Illuminate\Support\Str::limit($flow->feedback, 100)); ?>
    ...
    <div class="mt-8 p-6 bg-white rounded-lg shadow-md">
        ...
        <div class="flex flex-wrap gap-4">
            <a href="<?php echo e(route('teacher.learning-objectives.create')); ?>" class="px-5 py-3 text-base font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700">
                + Buat Tujuan Pembelajaran
            </a>
            <a href="<?php echo e(route('teacher.teaching-flows.index')); ?>" class="px-5 py-3 text-base font-medium text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300">
                Lihat Semua Alur Pembelajaran
            </a>
             <a href="<?php echo e(route('teacher.lesson-plans.start')); ?>" class="px-5 py-3 text-base font-medium text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300">
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\myapp\resources\views/guru/dashboard.blade.php ENDPATH**/ ?>